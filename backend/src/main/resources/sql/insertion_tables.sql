...
INSERT INTO spell (
    ...
    cooldown, use_per_turn, use_per_target, direction, ratio_eval_mode, icon_id, is_aoe
             ...
             0, 4, 0, 3, TRUE, TRUE,
             0, 99, 99, 'AREA', 'STEP', 2839, FALSE
         );

-- Ratio
INSERT INTO spell_ratio_breakpoint (spell_id, kind, lvl, ratio)
VALUES ('XEL_DEVOUEMENT', 'NORMAL', 200, 0);
...
INSERT INTO spell (
    ...
    cooldown, use_per_turn, use_per_target, direction, ratio_eval_mode, icon_id, is_aoe
             ...
             0, 1, 0, 1, FALSE, FALSE,
             0, 1, 1, 'NONE', 'STEP', 3909, FALSE
         );

-- Ratio (aucun dégât)
INSERT INTO spell_ratio_breakpoint (spell_id, kind, lvl, ratio)
VALUES ('XEL_VDT', 'NORMAL', 200, 0);
...
INSERT INTO passive (id, class_id, name, description, icon_id) VALUES
    ('XEL_MECANISMES_SPECIALISES','XEL','Mécanisme spécialisé',
     'À l''invocation d''un Rouage, Sinistro, Cadran ou Régulateur : échange immédiatement de position avec (6 cases max).', 7191);
